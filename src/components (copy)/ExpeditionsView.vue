<template>
  <section :class="[themeClasses.primaryBg, themeClasses.primaryText, themeClasses.accentBorder, 'p-6 rounded-lg shadow-xl border']">
    ...
    <p class="text-lg" :class="themeClasses.primaryText">
      Send your scholars on perilous journeys to retrieve rare artifacts and knowledge.
    </p>
    
    <p class="text-sm mt-4" :class="themeClasses.primaryText">Manage your expeditions, track their progress, and claim rewards here.</p>
  </section>
</template>
...
// NEW PROP: Accept the theme classes object
...
// Destructure for cleaner template access (optional)
const { themeClasses } = props;

console.log('ExpeditionsView: Component loaded.');
</script>

<style scoped>
/* Add any specific styles for ExpeditionsView here if needed */
</style>